  ...
  *************************************************** */
  public function vtwpr_get_variations_parameter($which_vargroup) {
    ...
    //************************
	  ...
	  $adding_to_cart      = wc_get_product( $product_id ); //v1.06 replace get_product with wc_get_product

  	$all_variations_set = true;
  	$variations         = array();

		$attributes = $adding_to_cart->get_attributes();
		$variation  = wc_get_product( $variation_id ); //v1.06 replace get_product with wc_get_product
